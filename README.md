...
<select>
  <option value="Pacific/Wake">(UTC+12:00) Wake Island</option>
  <option value="America/St_Johns">(UTC-03:00) St. John's, NL</option>
  <option value="Atlantic/Stanley">(UTC-03:00) Stanley, NB</option>
  <option value="America/Blanc-Sablon">(UTC-04:00) Blanc-Sablon, QC</option>
  <option value="America/Glace_Bay">(UTC-04:00) Glace Bay, NC</option>
  <option value="America/Goose_Bay">(UTC-04:00) Goose Bay, NL</option>
  <option value="America/Halifax">(UTC-04:00) Halifax, NS</option>
  <option value="America/Moncton">(UTC-04:00) Moncton, NB</option>
  <option value="America/Atikokan">(UTC-05:00) Atikokan, ON</option>
  <option value="America/Detroit">(UTC-05:00) Detroit, MI</option>
  <option value="America/Indiana/Indianapolis">(UTC-05:00) Indianapolis, IN</option>
  <option value="America/Iqaluit">(UTC-05:00) Iqaluit, NU</option>
  <option value="America/Kentucky/Louisville">(UTC-05:00) Louisville, KY</option>
  <option value="America/Indiana/Marengo">(UTC-05:00) Marengo, IN</option>
  <option value="America/Kentucky/Monticello">(UTC-05:00) Monticello, KY</option>
  <option value="America/New_York">(UTC-05:00) New York, NY</option>
  <option value="America/Nipigon">(UTC-05:00) Nipigon, ON</option>
  <option value="America/Pangnirtung">(UTC-05:00) Pangnirtung, NU</option>
  <option value="America/Indiana/Petersburg">(UTC-05:00) Petersburg, IN</option>
  <option value="America/Thunder_Bay">(UTC-05:00) Thunder Bay, ON</option>
  <option value="America/Toronto">(UTC-05:00) Toronto, ON</option>
  <option value="America/Indiana/Vevay">(UTC-05:00) Vevay, IN</option>
  <option value="America/Indiana/Vincennes">(UTC-05:00) Vincennes, IN</option>
  <option value="America/Indiana/Winamac">(UTC-05:00) Winamac, IN</option>
  <option value="America/North_Dakota/Beulah">(UTC-06:00) Beulah, ND</option>
  ...
  <option value="America/Menominee">(UTC-06:00) Menominee, MI</option>
  <option value="America/North_Dakota/New_Salem">(UTC-06:00) New Salem, ND</option>
  <option value="America/Rainy_River">(UTC-06:00) Rainy River, ON</option>
  <option value="America/Rankin_Inlet">(UTC-06:00) Rankin Inlet, NU</option>
  <option value="America/Regina">(UTC-06:00) Regina, SK</option>
  <option value="America/Resolute">(UTC-06:00) Resolute, NU</option>
  <option value="America/Swift_Current">(UTC-06:00) Swift Current, SK</option>
  <option value="America/Indiana/Tell_City">(UTC-06:00) Tell City, IN</option>
  <option value="America/Winnipeg">(UTC-06:00) Winnipeg, MB</option>
  <option value="America/Boise">(UTC-07:00) Boise, ID</option>
  <option value="America/Cambridge_Bay">(UTC-07:00) Cambridge Bay, NU</option>
  <option value="America/Creston">(UTC-07:00) Creston, BC</option>
  <option value="America/Dawson_Creek">(UTC-07:00) Dawson Creek, BC</option>
  <option value="America/Denver">(UTC-07:00) Denver, CO</option>
  <option value="America/Edmonton">(UTC-07:00) Edmonton, AB</option>
  <option value="America/Fort_Nelson">(UTC-07:00) Fort Nelson, BC</option>
  <option value="America/Inuvik">(UTC-07:00) Inuvik, NT</option>
  <option value="America/Phoenix">(UTC-07:00) Phoenix, AZ</option>
  <option value="America/Yellowknife">(UTC-07:00) Yellowknife, NT</option>
  <option value="America/Dawson">(UTC-08:00) Dawson, YT</option>
  <option value="America/Los_Angeles" selected>(UTC-08:00) Los Angeles, CA</option>
  <option value="America/Metlakatla">(UTC-08:00) Metlakatla, AK</option>
  <option value="America/Vancouver">(UTC-08:00) Vancouver, BC</option>
  <option value="America/Whitehorse">(UTC-08:00) Whitehorse, YT</option>
  <option value="America/Anchorage">(UTC-09:00) Anchorage, AK</option>
  <option value="America/Juneau">(UTC-09:00) Juneau, AK</option>
  <option value="America/Nome">(UTC-09:00) Nome, AK</option>
  <option value="America/Sitka">(UTC-09:00) Sitka, AK</option>
